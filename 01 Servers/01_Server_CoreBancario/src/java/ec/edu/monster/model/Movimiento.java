...
public class Movimiento {
    ...
    public Movimiento(String DTT_MOVIFECHA, String VCH_MOVITIPO, float DEC_MOVIVALOR, float DEC_MOVISALDOFINAL, String VCH_MOVICUENTORIG, String VCH_MOVICUENTDEST) {
    ...
    public Movimiento(int INT_MOVICODIGO, int INT_CUENCODIGO, String DTT_MOVIFECHA, String VCH_MOVITIPO, float DEC_MOVIVALOR, float DEC_MOVISALDOFINAL, String VCH_MOVICUENTORIG, String VCH_MOVICUENTDEST) {
    ...
    public String getDTT_MOVIFECHA() {
        return DTT_MOVIFECHA;
    }

    public void setDTT_MOVIFECHA(String DTT_MOVIFECHA) {
        this.DTT_MOVIFECHA = DTT_MOVIFECHA;
    }
